...
export default function HomeScreen({
  ...
  async function startSessionWithToken(_accessToken: string): Promise<void> {
    // VAPI client-side call bootstrap does not require LiveKit session tokens.
    setVoiceSession({
      wsUrl: '',
      token: '',
      roomName: 'vapi',
      userIdentity: currentAuth.userId,
    });
