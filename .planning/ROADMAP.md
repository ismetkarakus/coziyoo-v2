...
**Plans:** 3 plans
Plans:
- [ ] 01-01-PLAN.md -- Scaffold Next.js workspace and fix CORS defaults
...
- [ ] 01-03-PLAN.md -- Create deployment pipeline (systemd, install/update scripts, CI/CD integration)
...
|-------|----------------|--------|-----------|
| 1. Foundation | 1/3 | In Progress | 2026-03-22 (01-01) |
